...
export const GoalsSection = () => {
  return (
    ...
    <div className="grid gap-6 md:grid-cols-2 py-24">
      <div className="flex flex-col justify-start gap-10 rounded-2xl border border-primary-light bg-white/50 p-5 lg:p-10">
      ...
      <div className="border flex flex-col justify-between gap-10 rounded-2xl border-primary-light bg-white/50 p-5 lg:p-10">
      <ul>
          <li className="my-2">
