    ...
    <section className="py-32">
      <div className="container">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="rounded-lg border border-secondary-lighter text-muted-foreground bg-white/50 p-5">
          ...
          <div className="rounded-lg border border-secondary-lighter  bg-white/50 p-5">
