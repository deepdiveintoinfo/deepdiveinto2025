...
📂 Undone → 🖋️ Transcription → 🧠 Analysis → 🔍 Verification → ✅ Complete
...
* PDF Viewer: Adobe Acrobat (or similar PDF reader).
* ChatGPT Access (or [huggingfaces](https://huggingface.co/)): Open the LLM in two tabs or windows: one for transcription and one for comparison.
* Markdown Editor: Any text editor that supports Markdown (e.g., VS Code or Notepad).
