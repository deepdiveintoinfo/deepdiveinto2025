...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md p-1 text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      onClick={() => setSearchParams({...searchParams, tabKey: props.value})}
      {...props}
    />
  )
})
